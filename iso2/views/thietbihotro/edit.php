...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
    ...
    <form method="POST" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="chusohuu" required
                       value="<?php echo isset($_POST['chusohuu']) ? htmlspecialchars($_POST['chusohuu']) : htmlspecialchars($device['chusohuu']); ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="hosomay"
                       value="<?php echo isset($_POST['hosomay']) ? htmlspecialchars($_POST['hosomay']) : htmlspecialchars($device['hosomay']); ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="tlkt"
                       value="<?php echo isset($_POST['tlkt']) ? htmlspecialchars($_POST['tlkt']) : htmlspecialchars($device['tlkt']); ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="number" name="cdung" min="0"
                       value="<?php echo isset($_POST['cdung']) ? $_POST['cdung'] : $device['cdung']; ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="number" name="thly" min="0" max="99"
                       value="<?php echo isset($_POST['thly']) ? $_POST['thly'] : $device['thly']; ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-500">
            </div>
        </div>
        ...
        <div class="flex gap-2 pt-4">
            ...
            <a href="thietbihotro.php" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded inline-block">
