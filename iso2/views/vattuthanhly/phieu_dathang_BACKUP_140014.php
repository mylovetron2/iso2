        ...
        <div class="p-6">
            ...
            <form id="formPhieuDatHang" method="POST" action="/iso2/vattuthanhly.php?action=xuatphieudathang">
                ...
                <div class="mt-6 text-center flex flex-wrap gap-3 justify-center no-print">
                    ...
                    <a href="/iso2/vattuthanhly.php?action=taophieudathang" class="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-3 rounded-lg font-semibold inline-block">
