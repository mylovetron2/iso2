...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
        <h2 class="text-xl md:text-2xl font-bold mb-6">
            <i class="fas fa-plus-circle mr-2"></i>Thêm Đơn vị Khách hàng
        </h2>
        ...
        <form method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" name="madv" required
                       value="<?php echo htmlspecialchars($data['madv'] ?? ''); ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                       placeholder="Nhập mã đơn vị (VD: XDT, XKT...)">
            </div>
            ...
            <div>
                ...
                <input type="text" name="tendv" required
                       value="<?php echo htmlspecialchars($data['tendv'] ?? ''); ?>"
                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
