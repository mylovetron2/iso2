...
<div class="max-w-lg mx-auto bg-white rounded-lg shadow-md p-4 md:p-6 mt-4 md:mt-8">
    <h1 class="text-xl md:text-2xl font-bold mb-4">Sửa tiến độ công việc</h1>
    <form method="POST" action="tiendocongviec2.php?action=update&id=<?php echo $item['id']; ?>">
        <div class="mb-3 md:mb-4">
            ...
            <input type="text" name="ten_cong_viec" class="w-full px-3 py-2 border rounded text-sm md:text-base" value="<?php echo htmlspecialchars($item['ten_cong_viec']); ?>" required>
        </div>
        <div class="mb-4">
        ...
        <div class="flex flex-col md:flex-row gap-2">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm md:text-base w-full md:w-auto">Cập nhật</button>
