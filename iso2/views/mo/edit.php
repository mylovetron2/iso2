...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6 flex items-center">
            <i class="fas fa-edit mr-2 text-yellow-600"></i>Sửa Mỏ
        </h1>
        ...
        <form method="POST" action="mo.php?action=edit&id=<?php echo $item['stt']; ?>">
            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2">
                    Mã Mỏ <span class="text-red-500">*</span>
                </label>
                <input type="text" name="mamo" required 
                       value="<?php echo htmlspecialchars($item['mamo']); ?>"
            ...
            <div class="mb-4">
                ...
                <textarea name="tenmo" required rows="3"
                          class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Nhập tên mỏ"><?php echo htmlspecialchars($item['tenmo']); ?></textarea>
            </div>
