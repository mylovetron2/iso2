-- Quick migration script to add lichsudn_iso table
-- Run this file to create the audit logging table

USE iso;

-- Drop table if exists (for clean re-creation during development)
-- DROP TABLE IF EXISTS `lichsudn_iso`;

-- Create lichsudn_iso table
...
SELECT 'Table lichsudn_iso created successfully!' AS status;
DESCRIBE lichsudn_iso;
