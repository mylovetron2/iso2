<?php
/**
 * Script thực thi thêm cột vị trí sắp xếp vào bảng vật tư thanh lý
 */

require_once __DIR__ . '/config/database.php';

try {
    echo "<h2>Thêm cột vị trí sắp xếp vào bảng vật tư thanh lý</h2>";
    
    // Đọc file SQL
    $sql = file_get_contents(__DIR__ . '/add_vitri_sapxep_column.sql');
    
    if ($sql === false) {
        throw new Exception("Không thể đọc file add_vitri_sapxep_column.sql");
    }
    ...
    echo "<h3 style='color: green;'>✓ Hoàn thành! Đã thêm cột vị trí sắp xếp vào bảng vattu_thanh_ly_iso</h3>";
